...
// PIN I2C_SCL              PB0
// PIN I2C_SDA              PB2
#define DBG_TX_PIN          PB1 // Dbg UART pin
#define DBG_RX_PIN          PB3 // DBG UART pin
#define BEEP_PIN            PB4

// you can change the pin numbers to match your wiring:

SoftwareSerial mySerial(DBG_RX_PIN, DBG_TX_PIN); // @suppress("Abstract class cannot be instantiated")
...
uint32_t I2C_Register[5] = { INVALID_UNIT32, INVALID_UNIT32, INVALID_UNIT32,
    INVALID_UNIT32, INVALID_UNIT32 };
...
uint32_t reciv_data() {
  ...
  int32_t data = (uint32_t) buffer[3] << 24 | (uint32_t) buffer[2] << 16
...
void requestEvent() {
  send_data(reqest,
      reqest < sizeof(I2C_Register) ? I2C_Register[reqest] : INVALID_UNIT32);
}
